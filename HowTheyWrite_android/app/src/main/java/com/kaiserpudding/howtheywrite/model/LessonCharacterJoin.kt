...
@Entity(tableName = "lesson_character_join",
        primaryKeys = arrayOf("lessonId", "characterId"),
        foreignKeys = arrayOf(ForeignKey(entity = Lesson::class, parentColumns = arrayOf("id"), childColumns = arrayOf("lessonId"), onDelete = CASCADE),
                ForeignKey(entity = Character::class, parentColumns = arrayOf("id"), childColumns = arrayOf("characterId"), onDelete = CASCADE)),
        indices = arrayOf(Index(value = *arrayOf("lessonId", "characterId"), unique = true), Index(value = ["characterId"])))
